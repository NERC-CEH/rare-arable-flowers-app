    ...
    <ul data-role="listview">
        <li>
            <p>Thank you for your interest in this rare plants recording scheme
                and for your help in providing data on these species. This page
                explains how any personal data you submit to the <i>Rare Arable Flowers</i> app
        ...
        <li>
            ...
            <p>Your submitted records will be stored permanently and used to inform
                the conservation and study of rare plants in the future.</p>
        </li>
        <li>
            <strong>Who will have access to my personal data?</strong>

            <p>Only those directly involved in developing this app and running
                this rare arable plants or verifying records as experts, will
                have access to your email address. Unless required by law, data
                will not be made available to any third parties unless we have
                obtained your permission to do so.</p>
        </li>
        <li>
            <strong>Use of images submitted with the app</strong>

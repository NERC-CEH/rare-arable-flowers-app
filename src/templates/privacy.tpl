...
<div data-role="content">
    <ul data-role="listview" data-inset="true" style="max-width:800px;">
        ...
        <li>
            <strong>Use of images and sound files submitted with the app</strong>

            <p>By submitting a photograph or sound file with this app you:</p>
            <ul class="list-normal-white-space">
                ...
                <li>
                    <p>Waive all moral rights in, and arising from, your photograph(s) and/or sound files, but retain

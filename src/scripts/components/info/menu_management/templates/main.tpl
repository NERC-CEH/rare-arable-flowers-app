<ul class="table-view buttons"><li class="table-view-cell">
  ...
  <li class="table-view-cell">
    <a href="#info/management/location" class="navigate-right">
      <span class="media-object pull-left icon icon-map"></span>

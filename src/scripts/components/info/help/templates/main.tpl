<ul class="table-view accordion" id="accordion">
  ...
  <li class="table-view-cell">
    ...
    <p id="c1" class="collapse"
      ...
      Please press the plus <span class="icon icon-plus"></span> button
      next to a species you would like to record.
      This will bring you to the recording page where you can fill in the
      details of the sighting, like location,
      date, number seen etc.
      <br>
      <br>
      When finished, set for submission by pressing the paper plane
      <span class="icon icon-send"></span> send button in the header.
    </p>
  </li>
  <li class="table-view-cell">
    <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
  ...
  <li class="table-view-cell">
    ...
    <p id="c5" class="collapse"
       aria-labelledby="headingTwo" aria-expanded="false">
      To delete a record, swipe it left in the user account
      <span class="icon icon-user"></span> page and click
